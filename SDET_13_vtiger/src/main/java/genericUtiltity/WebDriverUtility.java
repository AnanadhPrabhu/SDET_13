...
/*
 * this class contains webdriver specific gernic methods
 * 
 */
...
public class WebDriverUtility {
	...
	/*
	 * this method wait for the element to be visibel
	 * @param driver
	 * @param element
	 */
	...
	/*
	 * this method enable user to handle dropdown using visible text
	 * @param element
	 * @param option
	 */
	...
	/**
	   ...
	   /*
	    * THIS MEHTODS IS USED TO TRANSFER DRIVER TOFRAME 
	    */
